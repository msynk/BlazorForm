...
/// <summary>
/// Compares values for <see cref="FieldCondition"/>. Handles loose, culture-invariant
/// comparison so conditions authored in JSON (strings) work against typed model values.
/// </summary>
public static class ConditionEvaluator
{
    public static bool Compare(object? actual, ConditionOperator op, object? expected)
    {
        switch (op)
        {
